...
public class OriginalDataRepositoryImpl{
    ...
    public List<OriginalData> listAnHourPreOriginalData(final String tableName,
        ...
        nativeSql.append(" SELECT od.id, ")
                 ...
                 .append("   AND od.instanceTime BETWEEN ?4 ")
                 .append("              AND date_add(?2, INTERVAL ?3 MINUTE) ")
    ...
    public List<OriginalData> fetchFrontOriginalDataByCal(final String itemCode,final Calendar calendar,final String tableName) {
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        StringBuilder nativeSql = new StringBuilder();
        nativeSql.append(" SELECT             ")
                ...
                .append("             max(o.id) ")
                .append("          FROM       ")
                .append("             " + tableName + " o, t_mesuringpoint p     ")
                .append("          WHERE ")
    ...
    public List<OriginalData> fetchBehindOriginalDataByCal(final String itemCode,final Calendar calendar,final String tableName) {
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        StringBuilder nativeSql = new StringBuilder();
        nativeSql.append(" SELECT             ")
