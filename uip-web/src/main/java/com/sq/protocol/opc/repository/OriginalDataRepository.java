...
public interface OriginalDataRepository extends BaseRepository<OriginalData, Long> {
    ...
    /** 获取指定时间之前的最近的一条记录 */
    List<OriginalData> fetchFrontOriginalDataByCal(String itemCode, Calendar calendar,String tableName);

    /** 获取指定时间之后的最近的一条记录 */
    List<OriginalData> fetchBehindOriginalDataByCal(String itemCode, Calendar calendar,String tableName);
