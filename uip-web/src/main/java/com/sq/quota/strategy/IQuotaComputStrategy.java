...
public abstract class IQuotaComputStrategy {
    ...
    public abstract Object execIndiComput(QuotaTemp quotaTemp, Calendar computCal) throws EvaluationException;
    ...
    public static boolean checkQuotaExpression (Evaluator evaluator, QuotaTemp quotaTemp) {
        ...
        if (null == variableList || variableList.size() == 0 || variableList.isEmpty()) {
