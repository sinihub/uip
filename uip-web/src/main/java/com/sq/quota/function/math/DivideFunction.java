    ...
    public FunctionResult execute(final Evaluator evaluator, final String arguments)
        ...
        try {
            ...
            if (argumentTwo == 0 || argumentOne == 0) {
                ...
                BigDecimal bigDecimal = new BigDecimal(argumentTwo.toString()).divide(new BigDecimal(argumentOne.toString()),20,BigDecimal.ROUND_HALF_UP);
                result = bigDecimal.setScale(20, BigDecimal.ROUND_HALF_UP).doubleValue();
            }
        } catch (Exception e) {
