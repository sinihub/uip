...
//            Double total = 0d;
            ...
            for (Double num : numbers) {
                totalBigDecimal = totalBigDecimal.add(new BigDecimal(num.toString()));
            }
            BigDecimal bigDecimal = totalBigDecimal.divide(new BigDecimal(numbers.size()+""),20,BigDecimal.ROUND_HALF_UP);
