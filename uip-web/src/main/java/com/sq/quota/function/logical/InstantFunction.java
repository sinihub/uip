...
public class InstantFunction implements Function {
    ...
    private static final Logger log = LoggerFactory.getLogger(InstantFunction.class);
    ...
    public FunctionResult execute(Evaluator evaluator, String arguments) throws FunctionException {
        ...
        List<OriginalData> frontOriginalDataList = originalDataRepository.fetchFrontOriginalDataByCal(quotaCode,computCal,tableName);
        List<OriginalData> behindOriginalDataList = originalDataRepository.fetchBehindOriginalDataByCal(quotaCode, computCal,tableName);
