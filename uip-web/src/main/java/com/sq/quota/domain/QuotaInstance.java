...
public class QuotaInstance extends QuotaBase {
    ...
    public QuotaInstance(QuotaTemp indicatorTemplate) {
        ...
        this.setEnterPriseId(indicatorTemplate.getEnterPriseId());
        this.setEquipMentId(indicatorTemplate.getEquipMentId());
    }
    ...
    public String toString() {
        return "QuotaInstance{" +
                "id=" + id +
                ", indicatorTempId=" + indicatorTempId +
                ", valueType=" + valueType +
